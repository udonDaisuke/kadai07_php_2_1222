    ...
    <div class="flex justify-center w-full">
        <form action="./bm_edit_exec.php?action=<?=h($action)?>&item_id=<?=h($id)?>" method ="post"  class="flex flex-col w-10/12" enctype="multipart/form-data">
            <div class="w-full flex flex-col justify-center py-5">
                ...
                <input name="img_url" class="transition-all bg-gray-100 rounded-sm outline-none outline-gray-200 hover:outline-2 hover:outline-blue-300" type="file" class="w-full" value="<?=h($result["img_url"])?>" accept="image/*">
